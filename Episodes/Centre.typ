...
// 本部小说部署在我个人的 GitHub Pages 上，使用 #link("https://typst.app/")[Typst] 标记语言进行编写，并通过 #link("https://github.com/Myriad-Dreamin/shiroa")[shiroa] 进行渲染与发布。

// 你可以使用 GitHub 的 Fork 功能将#link("https://github.com/shrike-505/Goddess/")[本仓库] Fork 到你自己的账户下，然后在本地进行修改，最后提交 Pull Request 到本仓库，注意在新剧情完成后将其加入上方的 Timeline。

// 在剧情方面，除了尽量不要吃书外，没有别的限制了（随意发挥吧:3）。

// 在排版与视觉效果方面，有新的点子也欢迎提出 Issue 发 PR。